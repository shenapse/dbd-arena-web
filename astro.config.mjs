...
export default defineConfig({
  ...
  redirects: {
    ...
    '/regulations/1v4-duo/balancing/pig/': '/game-modes/1v4-duo/balancing/pig/',
                  ...
                  items: [
                    ...
                    { label: 'General Rule', translations: { ja: '基本ルール' }, slug: 'game-modes/1v4-quartet/rules/general' },
                    {
                      ...
                      items: [
                        ...
                        { label: 'Doctor', translations: { ja: 'ドクター' }, slug: 'game-modes/1v4-quartet/balancing/doctor' },
                        { label: 'Nightmare', translations: { ja: 'ナイトメア' }, slug: 'game-modes/1v4-quartet/balancing/nightmare' },
                        { label: 'Pig', translations: { ja: 'ピッグ' }, slug: 'game-modes/1v4-quartet/balancing/pig' },
                        { label: 'Clown', translations: { ja: 'クラウン' }, slug: 'game-modes/1v4-quartet/balancing/clown' },
                        { label: 'Oni', translations: { ja: '鬼' }, slug: 'game-modes/1v4-quartet/balancing/oni' },
                        { label: 'Unknown', translations: { ja: 'アンノウン' }, slug: 'game-modes/1v4-quartet/balancing/unknown' },
                        { label: 'Lich', translations: { ja: 'リッチ' }, slug: 'game-modes/1v4-quartet/balancing/lich' },
