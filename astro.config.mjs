...
export default defineConfig({
  ...
  redirects: {
    ...
    '/regulations/1v4-quartet/balancing/demogorgon/': '/game-modes/1v4-quartet/balancing/demogorgon/',
    ...
    '/regulations/1v4-quartet/balancing/slasher/': '/game-modes/1v4-quartet/balancing/slasher/',
                  ...
                  items: [
                    { label: 'Overview', translations: { ja: '概要', ko: '개요' }, slug: 'game-modes/1v4-quartet' },
                    {
                      ...
                      items: [
                        ...
                        { label: 'Clown', translations: { ja: 'クラウン', ko: '클라운' }, slug: 'game-modes/1v4-quartet/balancing/clown' },
                        ...
                        { label: 'Dredge', translations: { ja: 'ドレッジ', ko: '드레지' }, slug: 'game-modes/1v4-quartet/balancing/dredge' },
