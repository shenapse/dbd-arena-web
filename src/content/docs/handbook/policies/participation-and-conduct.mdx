...
description: Standards for fair play, respectful conduct, violations, and consequences.
status: active
changeHistory:
  - version: "1.0"
    date: "2026-06-15"
...
For requirements to join Arena, see [Eligibility and Participation](/handbook/policies/eligibility-and-participation/).
...
- **Follow and respect Arena rules.** Play by the rules of the game mode you queued for, and report results truthfully.
