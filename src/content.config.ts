  ...
  i18n: defineCollection({
    ...
    schema: i18nSchema({
      extend: z.object({
        ...
        'balancingList.survivorRepetitionLimit.team.max1': z.string().optional(),
        'balancingList.survivorRepetitionLimit.team.maxN': z.string().optional(),
        'balancingList.survivorRepetitionLimit.duo.max1': z.string().optional(),
        'balancingList.survivorRepetitionLimit.duo.maxN': z.string().optional(),
